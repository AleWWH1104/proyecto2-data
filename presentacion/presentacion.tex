...
\begin{frame}{Introducción y base conceptual}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{block}{Contexto}
        \begin{itemize}
          \item HuBMAP: mapear el cuerpo humano a nivel de célula
          \item \alert{FTU}: grupo de células alrededor de un vaso sanguíneo con una función en el
                órgano
          \item Cinco órganos, cinco tipos de FTU distintos
          \item Tinción \alert{PAS} $\rightarrow$ tono rosado/morado en las imágenes
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{block}{Situación actual}
        \begin{itemize}
          \item Hoy un \alert{patólogo marca las FTU a mano}
          \item Lento, subjetivo, no escala
          \item Muestras del mismo órgano se ven distinto según el laboratorio
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
